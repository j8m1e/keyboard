...
#define LAYOUT_65_with_macro( \
  ...
  LE9, LE8, LE1,      LE3, LE4, LE5, LE6,        RE1,      RE3, RE4, RE5, RE6, RE7, RE8, RE9 \
  ) \
  { \
    { LA1, LA2, LA3, LA4, LA5, LA6, LA7, LA8, LA9 }, \
    { LB1, LB2, LB3, LB4, LB5, LB6, KC_NO, LB8, LB9 }, \
    { LC1, LC2, LC3, LC4, LC5, LC6, KC_NO, LC8, LC9 }, \
    { LD1, KC_NO, LD3, LD4, LD5, LD6, LD7, LD8, LD9 }, \
    { LE1, KC_NO, LE3, LE4, LE5, LE6, KC_NO, LE8, LE9 }, \
    { RA1, RA2, RA3, RA4, RA5, RA6, RA7, RA8, RA9 }, \
    { RB1, RB2, RB3, RB4, RB5, RB6, RB7, RB8, RB9 }, \
    { RC1, RC2, RC3, RC4, RC5, RC6, KC_NO, RC8, RC9 }, \
    { RD1, RD2, RD3, RD4, KC_NO, RD6, RD7, RD8, RD9 }, \
